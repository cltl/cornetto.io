...
The database browser allows you to view the data currently in the Cornetto database. See the [Disclaimer](#disclaimer) for terms and conditions governing the access provided. See [User Manual](#manual) for further information on installation and use of the Cornetto Demo, or [contact us](#contact) in case you have any further questions. The data of the final results of the Cornetto project are available through the [TST-centrale](http://taalunieversum.org/taal/technologie/) of the [Nederlandse Taalunie](http://taalunieversum.org/taalunie/).  
The acquisition demo can be accessed through <http://www.let.rug.nl/erikt/bin/setdemo.cgi>. Instructions are included.  
Finally, Erwin Marsi kindly provided another interface to the Cornetto datase that incorporates also word similarity calculation. This demo can be accessed from <http://daeso.uvt.nl/demos/index.html>.
...
We appreciate your feedback on the Cornetto database at any stage of the project. Please email piek.vossen (at) vu.nl for technical problems or general feedback. 
